...
require("lazy").setup({
    ...
    {'rebelot/kanagawa.nvim'},{'rockerBOO/boo-colorscheme-nvim'},{'slugbyte/lackluster.nvim'},{"nyoom-engineering/oxocarbon.nvim"},
   ...
   -- {'nvim-treesitter/nvim-treesitter'},
    ...
    {'hrsh7th/cmp-nvim-lsp-signature-help'}, {
       ...
       { 'hrsh7th/vim-vsnip' },
    {'hrsh7th/vim-vsnip-integ'},{'rktjmp/lush.nvim'},
{
  "folke/flash.nvim",
  event = "VeryLazy",
  ---@type Flash.Config
